...
class AboutMessagePassing < EdgeCase::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # I guess it is because, the class you define might need to have a custom send method
    # related to its logic. In that case send would be related to your class, and you would
    # use __send__ to send messages to the object.
  end
