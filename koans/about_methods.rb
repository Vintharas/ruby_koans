...
class AboutMethods < EdgeCase::Koan
  ...
  def test_calling_with_variable_arguments
    # the input argument behaves like a vector (we can see it clearly when we don't pass any arguments
    # the return is not nil but an empty array
    # Actually, you can clearly see it in how it behaves with any number of arguments XD
