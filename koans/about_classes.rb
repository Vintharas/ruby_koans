...
class AboutClasses < EdgeCase::Koan
  ...
  def test_args_to_new_must_match_initialize
    ...
    # THINK ABOUT IT:
    # Why is this so?
    # When you create a class and you don't define the constructor
    # it guess a default constructor with no arguments by default,
    # when you define your own constructor, this default zero-argument
    # constructor is not created (I guess like in other languages)
  end
