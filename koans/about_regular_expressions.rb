...
class AboutRegularExpressions < EdgeCase::Koan
  ...
  #
  # Why?
  # Because they take as much characters as they can, they are greed for characters.
  ...
  def test_variables_can_also_be_used_to_access_captures
    # I thought this was strange, 'cause I didn't realize there was a comma in the regex!
  ...
  # A character class works like an AND-style character matching in which a given string
  # matches a regular expression only if it matches all its components.
  # An alternation works more like an OR-style character matching in which a given string
  # matches a regular expression if it matches any of a defined set of choices. (those connected by |)
  ...
  def test_sub_is_like_find_and_replace
    # you replace the first matched element with the stuff that it is in the block
    # in this case a substring
