...
class AboutClassMethods < EdgeCase::Koan
  ...
  # The second way to do it might show a greater distinction between
  # object methods within a class and class methods, i.e., between
  # instance methods and static ones.
