...
class AboutSymbols < EdgeCase::Koan
  ...
  # Because you cannot get a direct reference of the method symbol?
  ...
  # Because they are inmutable and, if abused, will take up the memory
  # the program is using (looks like they re not freed from memory until
